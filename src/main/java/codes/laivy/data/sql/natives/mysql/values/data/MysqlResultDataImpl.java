package codes.laivy.data.sql.natives.mysql.values.data;
 ...
 */
@ApiStatus.Internal
public class MysqlResultDataImpl implements MysqlResultData {
    ...
    public MysqlResultDataImpl(@NotNull ResultSet result) {
        this.result = result;
