...
public class MysqlLongVariableType implements SqlNumberVariableType<MysqlVariable>, MysqlVariableType<MysqlVariable> {
    @Override
    public void set(@Nullable Object object, @NotNull SqlParameters parameters, @Nullable SqlMetadata metadata) {
        if (object == null) {
            ...
            parameters.setLong((Long) object);
        } else if (object instanceof Integer) {
            parameters.setInt((Integer) object);
        } else {
            throw new IllegalArgumentException("To use the long variable type, the object needs to be a long or int!");
        }
    }
